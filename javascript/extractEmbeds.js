// Helper function to extract embeded asset's URL.  IMPORTANT -- Will only pull assets (MP4s mainly) provided by Tenor, as Tenor GIF's (stored as MP4s) are integrated into the Discord UI.  Other
